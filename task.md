...
- [x] Phase 2: Advanced AI & "Pure CV"
    ...
    - [x] Implement "Anti-Static" Check (Detect Photo Spoofing)
  - [x] Enforce Strict Range of Motion (No partial reps) (Handled in logic)

- [x] **Phase 12: Premium Dashboard UI**
  - [x] **Layout**: Create Sidebar + Main Grid Structure.
  - [x] **Dashboard View**: Implement Stat Cards & Charts.
  - [x] **Workout View**: Refactor Camera/Controls into a separate tab.
  - [x] **CSS**: Implement Vibrant/Premium theme.
...
- [x] Phase 5: Gmail Approval Automation
    ...
    - [x] **Implementation**
        ...
        - [x] Implement `checkGmailApproval()` background loop.
...
- [x] Phase 6: Google Sheets Data Persistence
    ...
    - [x] **Implementation**
        ...
        - [x] Implement `syncToSheets()` logic.
...
- [x] Phase 8: Offline Voice Assistant (Vosk)
    ...
    - [x] **Implementation**
        ...
        - [x] Update `VoiceAssistant` to use Vosk engine.
    - [x] **Verification**
...
- [x] Phase 7: Voice Assistant ("Hey Buddy")
    ...
    - [x] **Implementation**
        - [x] Implement `VoiceAssistant` class/module.
...
- [x] Phase 9: Voice Sensitivity Tuning
    ...
    - [x] **Implementation**
        ...
        - [x] Add command processing in `handlePartialResult`.
        - [x] Add `recognizer.reset()` after wake-word detection.
    - [x] **Verification**
        - [x] Test immediate response after "Yes?".

- [x] Phase 10: Automatic Gmail + Instant Buttons [FINAL]
    - [x] **Research & Planning**
        - [x] Design Hybrid workflow (Gmail Send + Web App Click).
        - [x] Verify `apps_script.js` content.
    - [x] **Implementation**
        - [x] Add `prompt` to ask user for `WEB_APP_URL`.
        - [x] Update `sendEmail` to use Web App links.
        - [x] Switch back to `pollSheetStatus`.
    - [x] **Verification**
        - [x] Verify Email sends automatically.
        - [x] Verify "Approve" link updates Sheet.
        - [x] Verify App polls Sheet and unlocks.

- [x] **Phase 13: Enhanced UX & Insights [NEW]**
    - [x] **Actionable Insights Panel**
        - [x] Create UI section for "Coach Tips".
        - [x] Implement logic: Suggest exercises based on goals/time.
        - [x] **User Request**: Black text + Scrollbar.
    - [x] **Personalization**
        - [x] Enhance Header with User Name & Greeting.
        - [x] Add "My Goals" or simple settings to Sidebar.
    - [x] **Fine Body Tracking**
        - [x] Enhance `drawSkeleton()` in `script.js` to show colored joints/segments.
        - [x] Highlight active joints (e.g., elbows for pushups).
    - [x] **UI Optimization**
        - [x] Refine "Glassmorphism" visuals (css).
        - [x] Ensure full responsiveness on all devices.

- [x] **Phase 14: Layout Editor (Wix-Style) [NEW]**
    - [x] **Designer Mode UI**
        - [x] Add floating "Edit Layout" FAB (Floating Action Button).
        - [x] Toggle `contenteditable` on text elements.
    - [x] **Drag & Drop Logic**
        - [x] Make Sections (`#dashboardSection`, `#workoutSection`) draggable.
        - [x] Make Stat Cards draggable.
    - [x] **Persistence**
        - [x] Save DOM order to `localStorage`.
        - [x] Restore layout on `App.init()`.

- [x] **Phase 15: Compliance [FINAL]**
    - [x] **Privacy Policy**: Created `privacy.html` explaining Local processing & Gmail/Sheets usage.
    - [x] **Terms of Service**: Created `terms.html` with Health Disclaimer.

- [ ] **Phase 16: Deployment [CURRENT]**
    - [x] **Create Guide**: Document hosting steps (`deployment_guide.md`).
    - [ ] **Google Console Update**: Remind user to add new domain to Authorized Origins.
    - [ ] **Verify Production**: Test on the hosted URL.
